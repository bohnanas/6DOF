...
data_02_sim_01 = pd.read_csv('./NASA_data/trajectory_data/Atmos_03_TumblingBrickDamping/Atmos_03_sim_01.csv', header=0)
data_02_sim_02 = pd.read_csv('./NASA_data/trajectory_data/Atmos_03_TumblingBrickDamping/Atmos_03_sim_02.csv', header=0)
data_02_sim_04 = pd.read_csv('./NASA_data/trajectory_data/Atmos_03_TumblingBrickDamping/Atmos_03_sim_04.csv', header=0)
data_02_sim_05 = pd.read_csv('./NASA_data/trajectory_data/Atmos_03_TumblingBrickDamping/Atmos_03_sim_05.csv', header=0)
data_02_sim_06 = pd.read_csv('./NASA_data/trajectory_data/Atmos_03_TumblingBrickDamping/Atmos_03_sim_06.csv', header=0)
data_02_pysim  = np.load('./my_saved_data/atmos03/atmos03.npy')
